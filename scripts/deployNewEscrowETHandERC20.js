...
async function main() {
  ...
  tx = await ecf.createNewEscrow(
    "0x29c36265c63fE0C3d024b2E4d204b49deeFdD671", // Client (Eric #1 test address)
    "0x48Fa9E29c4eCC20170aA565fFA2d60AB09c8f440", // Dev (Eric #2 test address)
    "0xAbEec041894DCE885fdc04cbDDecEE09CE2C53c2", // Freeflow (CrossChain Address)
    true
  );
  await tx.wait();
